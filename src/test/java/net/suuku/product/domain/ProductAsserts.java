...
import static net.suuku.product.domain.AssertUtils.bigDecimalCompareTo;
...
public class ProductAsserts {
    ...
    public static void assertProductUpdatableFieldsEquals(Product expected, Product actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getItemSize()).as("check itemSize").isEqualTo(expected.getItemSize()))
