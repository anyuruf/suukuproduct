package net.suuku.product.domain;

import static net.suuku.product.domain.OrderItemTestSamples.*;
import static net.suuku.product.domain.ProductOrderTestSamples.*;
import static net.suuku.product.domain.ProductTestSamples.*;
import static org.assertj.core.api.Assertions.assertThat;

import net.suuku.product.web.rest.TestUtil;
