...
import static net.suuku.product.domain.OrderItemAsserts.*;
import static net.suuku.product.web.rest.TestUtil.createUpdateProxyForBean;
import static net.suuku.product.web.rest.TestUtil.sameNumber;
...
import net.suuku.product.domain.OrderItem;
import net.suuku.product.domain.Product;
...
import net.suuku.product.repository.OrderItemRepository;
import net.suuku.product.service.OrderItemService;
...
class OrderItemResourceIT {
    ...
    public static OrderItem createEntity(EntityManager em) {
        ...
        productOrder = em.insert(ProductOrderResourceIT.createEntity()).block();
    ...
    public static OrderItem createUpdatedEntity(EntityManager em) {
        ...
        // Add required entity
        ProductOrder productOrder;
        productOrder = em.insert(ProductOrderResourceIT.createUpdatedEntity()).block();
    ...
    void partialUpdateOrderItemWithPatch() throws Exception {
        ...
        partialUpdatedOrderItem.totalPrice(UPDATED_TOTAL_PRICE).status(UPDATED_STATUS);
