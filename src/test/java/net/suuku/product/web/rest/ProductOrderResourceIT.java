...
import static net.suuku.product.domain.ProductOrderAsserts.*;
...
import net.suuku.product.domain.enumeration.OrderStatus;
...
class ProductOrderResourceIT {
    ...
    void partialUpdateProductOrderWithPatch() throws Exception {
        ...
        partialUpdatedProductOrder.status(UPDATED_STATUS).code(UPDATED_CODE).customer(UPDATED_CUSTOMER);
