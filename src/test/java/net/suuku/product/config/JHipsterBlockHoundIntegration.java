...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("net.suuku.product.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("net.suuku.product.security.DomainUserDetailsService", "createSpringSecurityUser");
