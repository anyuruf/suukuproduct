package net.suuku.product.repository;

import io.r2dbc.spi.Row;
import io.r2dbc.spi.RowMetadata;
import java.util.List;
import net.suuku.product.domain.OrderItem;
import net.suuku.product.repository.rowmapper.OrderItemRowMapper;
import net.suuku.product.repository.rowmapper.ProductOrderRowMapper;
import net.suuku.product.repository.rowmapper.ProductRowMapper;
