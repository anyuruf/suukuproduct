...
import net.suuku.product.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link net.suuku.product.domain.OrderItem}.
 */
@RestController
...
public class OrderItemResource {
    ...
    private static final String ENTITY_NAME = "suukuProductOrderItem";
