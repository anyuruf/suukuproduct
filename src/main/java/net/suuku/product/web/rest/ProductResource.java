...
import net.suuku.product.repository.ProductRepository;
import net.suuku.product.service.ProductService;
...
/**
 * REST controller for managing {@link net.suuku.product.domain.Product}.
 */
@RestController
...
public class ProductResource {
    ...
    private static final String ENTITY_NAME = "suukuProductProduct";
